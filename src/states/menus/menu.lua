...
function Menu:left() if self.type == States.FailState then self.moveSFX:play() end end
function Menu:right() if self.type == States.FailState then self.moveSFX:play() end end
